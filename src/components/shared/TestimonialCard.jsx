...
export default function TestimonialCard({ img, title, desc }) {
  return (
    ...
    <div className='flex flex-col  sm:flex-row  p-[30px] gap-3.5  rounded-[40px] border testy-border border-[#6D91EE]  max-w-sm  sm:max-w-[577px]  transition hover:-translate-y-1'>
      {/* Testimonial Image */}
